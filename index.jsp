        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="user-profile animate__animated animate__fadeInRight">
                    <img src="https://ui-avatars.com/api/?name=Krishmal2004&background=random" 
                         alt="User Avatar" 
                         class="user-avatar">
                    <div class="user-info">
                        <small>Welcome,</small>
                        <div class="fw-bold">Krishmal2004</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mb-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <a href="#" class="footer-link"><i class="fas fa-phone me-2"></i>+1 234 567 890</a>
                    <a href="#" class="footer-link"><i class="fas fa-envelope me-2"></i>contact@realestate.com</a>
